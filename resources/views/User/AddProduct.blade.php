        ...
        <div class="container">
            <div class="row row-cols-3">
                    <div class="col">
                      ...
                      <input type="text" name="name" class="form-control" id="inputEmail4" placeholder="name of product">
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                      ...
                      <input type="text" name="price" value="" class="form-control" id="inputCity">
                    </div>
                    <div class="col">
